...
class IndexStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getStats = channel.unary_unary(
                ...
                response_deserializer=index__pb2.BarrelStats.FromString,
                _registered_method=True)
...
def add_IndexServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getStats': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=index__pb2.BarrelStats.SerializeToString,
            ),
    }
...
class Index(object):
    ...
    def getStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            index__pb2.BarrelStats.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class GatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getSystemStats = channel.unary_unary(
                '/search.Gateway/getSystemStats',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=index__pb2.SystemStatsResponse.FromString,
                _registered_method=True)
...
def add_GatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getSystemStats': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=index__pb2.SystemStatsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class Gateway(object):
    ...
    def getSystemStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/search.Gateway/getSystemStats',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            index__pb2.SystemStatsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class ServerStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.pushSystemStats = channel.unary_unary(
                '/search.Server/pushSystemStats',
                request_serializer=index__pb2.SystemStatsResponse.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
...
def add_ServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'pushSystemStats': grpc.unary_unary_rpc_method_handler(
                    servicer.pushSystemStats,
                    request_deserializer=index__pb2.SystemStatsResponse.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'search.Server', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('search.Server', rpc_method_handlers)
...
class Server(object):
    ...
    def pushSystemStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/search.Server/pushSystemStats',
            index__pb2.SystemStatsResponse.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
